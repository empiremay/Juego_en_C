...
void Aclaracion() {
	printf("Bienvenido a mi juego en C versi%cn 0.3.3\n\n\n",162);
...
int main() {
	...
	int nivel_extra[N][N]={{7,10,0,2,2,0,8},{10,1,1,2,1,9,0},{10,1,2,2,9,0,1},{0,1,0,1,1,1,2},{0,0,0,2,1,0,6},{9,9,0,1,0,0,0},{5,2,2,2,10,10,3}};
