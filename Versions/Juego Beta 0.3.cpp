...
void Aclaracion() {
	printf("Bienvenido a mi juego en C versi%cn 0.3\n\n\n",162);
...
void notas() {
	printf("Notas del Parche 0.3:\n\n");
	printf("   %c A%cadidas llaves\n",175,164);
	printf("   %c A%cadido nuevo bloque de curaci%cn\n",175,164,162);
	printf("   %c A%cadido nuevo bloque de da%co\n",175,164,164);
	printf("   %c A%cadido nuevo nivel\n",175,164);
	printf("   %c Nueva mec%cnica en el nivel 3 que dificulta las cosas\n",175,160);
	printf("   %c La barra de vida se encuentra ahora arriba\n",175);
	printf("   %c Nuevo sistema de navegaci%cn w,a,s,d ahora con letras may%csculas",175,162,163);
	printf("\n\n");
	system("pause");
}
...
void dispVida(tEstado *estado) {
	...
	if((estado->vida)<501) {
		if((estado->vida)>400) {
			printf("Vida:%c%c%c%c%c%c",254,254,254,254,254,0);
		}
		else {
			if((estado->vida)>300) {
				printf("Vida:%c%c%c%c%c%c",254,254,254,254,0,0);
			}
			else {
				if((estado->vida)>200) {
					printf("Vida:%c%c%c%c%c%c",254,254,254,0,0,0);
				}
				else {
					if((estado->vida)>100) {
						printf("Vida:%c%c%c%c%c%c",254,254,0,0,0,0);
					}
					else {
						if((estado->vida)>0) {
							printf("Vida:%c%c%c%c%c%c",254,0,0,0,0,0);
						}
						else {
							printf("Vida:%c%c%c%c%c%c",0,0,0,0,0,0);
						}
					}
				}
			}
...
int main() {
	...
	int nivel_3[N][N]={{5,1,0,0,0,1,0},{0,10,9,9,9,1,7},{0,10,0,1,9,10,8},{1,1,2,0,2,2,10},{10,10,1,0,10,10,10},{8,10,1,9,10,10,10},{0,0,0,8,10,10,3}};
	int k;
	char op;
	int nivel=0;
