...
void Aclaracion() {
	printf("Bienvenido a mi juego en C versi%cn 0.3.2\n\n\n",162);
...
void notas() {
	printf("Notas del Parche 0.3.2:\n\n");
	printf("   %c Modificaci%cn del nivel 3 FINAL\n",175,162);
	printf("   %c A%cadido Easter Egg\n",175,164);
	printf("   %c Cambios en el sistema de niveles\n",175);
	printf("   %c 284 l%cneas m%cs de c%cdigo :)\n",175,161,160,162);
	printf("   %c Cambios est%cticos",175,130);
	printf("\n\n");
	system("pause");
}
...
int main() {
	...
	int nivel_extra[N][N]={{7,10,0,2,1,0,8},{10,1,1,2,1,9,0},{10,1,2,2,9,0,0},{0,1,0,1,1,1,2},{1,0,0,2,1,0,6},{9,9,0,1,0,0,0},{5,2,2,2,10,1,3}};
