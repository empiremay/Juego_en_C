...
void Aclaracion() {
	printf("Bienvenido a mi juego en C version 0.2.2\n\n");
...
void notas() {
	printf("Notas del Parche 0.2.2:\n\n");
	printf("   %c Niveles mas dificiles\n",175);
	printf("   %c A%cadido un nuevo identificador del lugar objetivo\n",175,164);
	printf("   %c Nuevo nivel anadido\n",175);
	printf("   %c Nuevo sistema de bloques invisibles inalcanzables\n",175);
	printf("   %c A%cadido un nuevo tipo de bloque\n",175,164);
	printf("   %c Corregido error de aclaracion\n",175);
	printf("   %c Cambios visuales varios",175);
	printf("\n\n");
	system("pause");
}
