...
void Aclaracion() {
	printf("Bienvenido a mi juego en C versi%cn 0.3.4\n\n\n",162);
...
void notas() {
	printf("Notas del Parche 0.3.4:\n\n");
	printf("   %c A%cadido 1 nuevo bloque (ID: 12)\n",175,164);
	printf("   %c Optimizadas cientas de l%cneas\n",175,161);
	printf("   %c Solucionado un bug en el Nivel Extra",175);
	printf("\n\n");
	system("pause");
}
...
int main() {
	...
	int nivel_3[N][N]={{0,1,2,0,0,1,8},{0,10,10,7,1,0,6},{5,1,0,10,10,10,11},{7,2,0,10,10,10,10},{1,10,9,8,1,6,3},{1,9,0,7,9,2,10},{1,0,2,1,2,0,10}};
	int nivel_extra[N][N]={{7,10,0,2,2,0,8},{10,1,1,2,1,9,0},{10,10,2,2,9,0,1},{10,1,0,1,1,1,2},{0,0,0,2,1,0,6},{9,9,0,1,10,0,0},{5,2,2,2,10,10,3}};
	int nivel_5[N][N]={{0,1,2,0,0,1,8},{0,10,10,7,1,0,6},{5,1,0,10,10,10,10},{7,2,0,10,10,10,10},{1,10,9,8,1,6,3},{1,9,0,7,9,2,10},{1,0,2,1,2,0,10}};
	int nivel_prueba[N][N]={{5,1,1,8,12,12,8},{10,8,8,10,10,12,12},{5,12,0,0,0,0,0},{1,8,8,8,7,8,8},{10,10,10,10,10,10,7},{7,7,7,7,7,2,1},{7,7,7,7,7,7,7}};
	int k;
	char op;
	int nivel=1;
